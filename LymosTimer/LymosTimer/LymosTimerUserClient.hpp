...
class LymosTimer; // 前向声明

class LymosTimerUserClient final : public IOUserClient {
    OSDeclareDefaultStructors(LymosTimerUserClient)

private:
    task_t                     fClientTask {nullptr};
    LymosTimer*                fProvider {nullptr};
