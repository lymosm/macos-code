...
class WakeSync : public IOService {
    OSDeclareDefaultStructors(WakeSync)
private:
    // ✨ 唤醒后延时任务
    ...
    WakeSyncUserClient* userClient {nullptr};
    friend class WakeSyncUserClient; // 让 user client 能访问需要的接口
