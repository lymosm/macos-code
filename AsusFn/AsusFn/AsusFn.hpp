...
#define AsusFnEventCode 0x8102

class AsusFn : public IOService {
    OSDeclareDefaultStructors(AsusFn)
...
public:
    ...
    IOHIDInterface* findHIDInterface(IOService* provider);
    ...
    static AsusFn* getSharedInstance();
    // 新增接口
    void increaseBrightness();

private:
    IOTimerEventSource* delaySource;  // 定时器事件源
